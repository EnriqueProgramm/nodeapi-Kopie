...
exports.hastAuthorization = (req, res, next) => {
    const authorized =
...
//         if(err){
//             return res.status(400).json({
//                 error: "Your are not authorized to perform this actions"
//             })
//         }
...
// find People....select at then end allow to define what to return
